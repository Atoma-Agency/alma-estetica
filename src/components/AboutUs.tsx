...
export function AboutUs() {
  return (
    <section id="about" className="w-full bg-background">
      <div className="mx-auto grid w-full max-w-360 items-center gap-16 px-6 py-20 md:px-12 lg:grid-cols-[520px_1fr] lg:gap-20">
        ...
        <div className="max-w-xl lg:py-8">
          ...
          <div className="mt-8 space-y-5 text-base leading-relaxed text-pretty text-muted-foreground sm:text-lg">
            <p>
